  ...
  return (
    <div className="flex min-h-screen bg-white dark:bg-slate-950 overflow-hidden">
      ...
      >
        ...
        <Suspense fallback={<div className="flex items-center justify-center h-48"><Loader2 className="animate-spin text-sky-500" /></div>}>
            <ResetPasswordForm />
        </Suspense>

        <div className="absolute bottom-8 left-12">
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                © 2026 MentorHub Global. Finalizing Recovery.
            </p>
        </div>
      </motion.div>
            ...
            <div className="absolute bottom-16 left-16 right-16">
                ...
                >
                    <h2 className="text-5xl font-black text-white tracking-tighter mb-4 leading-none">
                        Identity <br /> <span className="text-sky-400">Verified.</span>
                    </h2>
                    <p className="text-sky-50 font-medium text-lg max-w-lg leading-relaxed">
                        Complete your password reset to regain full access to your personalized mentorship network and progress tracking.
                    </p>
                </motion.div>
            </div>
        </div>
